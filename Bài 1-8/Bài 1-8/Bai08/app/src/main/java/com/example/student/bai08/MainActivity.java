package com.example.student.bai08;
...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView img2;
    ImageView img3;
    ArrayList CacLaBai = new ArrayList();
    private void xaoBai()
    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int i = rd.nextInt(CacLaBai.size()-1);
                XetBai = CacLaBai.get(i);
                img1.setImageResource(XetBai.Hinh);
            }
        });
